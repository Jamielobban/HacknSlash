...
public class PyramidTeleport : Interactive
{
    ...
    private void Start()
    {
        ...
        transform.DORotate(new Vector3(0, 0, 360) + this.transform.rotation.eulerAngles, period, RotateMode.FastBeyond360).SetEase(Ease.Linear).SetLoops(-1, LoopType.Incremental);
